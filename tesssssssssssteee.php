...
//-----------------------------------ELIMINAR DADOS-----------------------------------\\
    ...
    else $resultado = $conexao->query("SELECT AVALIACOES.ID, AVALIACOES.EDICAO_UC, UC.SIGLA, UC.ANO, AVALIACOES.EPOCA, AVALIACOES.INICIO, AVALIACOES.FIM FROM AVALIACOES JOIN UC ON AVALIACOES.EDICAO_UC = UC.id");
?>
<html lang="pt">
  <head>
